<?php $__env->startSection('title', 'Thêm mới Công Tác Đảng/Đoàn'); ?>
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                <li>
                    ...
                    <a href="<?php echo e(route('dang.index')); ?>">Danh Sách Tham Gia Hoạt Động Đảng Đoàn</a>
                </li>
            </ul>
        </div>
        <!-- END PAGE BAR -->
            ...
            <div class="col-md-12">
                <div class="tabbable tabbable-tabdrop">
                    ...
                    <div class="portlet light portlet-fit portlet-form" id="form_wizard_1">
                        <!-- BEGIN FORM-->
                        <form action="<?php echo e(route('dang.add.post')); ?>" method="post" id="form_sample_2" class="form-horizontal">
                            <?php echo csrf_field(); ?>
