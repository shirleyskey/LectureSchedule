        ...
        <div class="modal-content">
            <form action="#" id="form_edit_vanban">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="fa fa-edit"></i> Chỉnh sửa Văn Bản Xử Lý</h4>
                </div>
...
<!-- /.modal --><?php /**PATH /opt/lampp/htdocs/lectureSchedule/resources/views/vanban/modals/edit.blade.php ENDPATH**/ ?>