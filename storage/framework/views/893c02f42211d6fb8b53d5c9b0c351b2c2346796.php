            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit bordered">
                    <div class="portlet-body">
                        <?php if (app('laratrust')->can('create-hoctap')) : ?>
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a id="sample_editable_1_new" class="btn green" href="<?php echo e(route('hoctap.add.get')); ?>"><i class="fa fa-plus"></i> Thêm mới
                                        </a>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="btn-group pull-right">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            ...
                                            <li>
                                                <a href="<?php echo e(route('hoctap.export-excel.get')); ?>"><i class="glyphicon glyphicon-download-alt"></i> Xuất Excel </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <table class="table table-striped table-hover table-bordered" id="ds_nguoi_dung">
                            ...
                            <tbody>
                                <?php if( $ds_hoctap->count() > 0 ): ?>
                                    <?php $stt = 1; ?>
                                    <?php $__currentLoopData = $ds_hoctap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-xs yellow-gold" href="<?php echo e(route('hoctap.edit.get', $v->id)); ?>" title="Sửa"> <i class="fa fa-edit"></i> Sửa</a>
                                            <?php endif; // app('laratrust')->can ?>
                                            <?php if (app('laratrust')->can('delete-hoctap')) : ?>
                                            <a class="btn btn-xs red-mint" href="<?php echo e(route('hoctap.delete.get', $v->id)); ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa Công tác này không?');" title="Xóa"> <i class="fa fa-trash"></i> Xóa</a>
                                            <?php endif; // app('laratrust')->can ?>
                                        </td>
                                    </tr>
                                    <?php $stt++; ?>
