        ...
        <div class="modal-content">
            <form action="#" id="form_edit_hdkh">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="fa fa-edit"></i> Chỉnh sửa Hướng Dẫn Khoa Học</h4>
                </div>
...
<!-- /.modal --><?php /**PATH /opt/lampp/htdocs/lectureSchedule/resources/views/hdkh/modals/edit.blade.php ENDPATH**/ ?>