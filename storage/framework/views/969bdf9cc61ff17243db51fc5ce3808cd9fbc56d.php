                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <div class="input-icon right">
                                    ...
                                    <input type="number" class="form-control" name="quymo" required value="<?php echo e(old('quymo')); ?>" /> </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <div class="input-icon right">
                                    ...
                                    <input type="number" step="any" class="form-control" name="he" required value="<?php echo e(old('he')); ?>" /> </div>
                            </div>
                        </div>
...
</form><?php /**PATH /opt/lampp/htdocs/lectureSchedule/resources/views/lop/add/form.blade.php ENDPATH**/ ?>