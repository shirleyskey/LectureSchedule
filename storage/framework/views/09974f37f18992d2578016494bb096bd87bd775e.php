<?php $__env->startSection('title', 'Chỉnh sửa Thông tin Chấm bài'); ?>
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                <li>
                    ...
                    <a href="<?php echo e(route('chambai.index')); ?>">Sửa Thông Tin Chấm Bài</a>
                </li>
            </ul>
        </div>
        <!-- END PAGE BAR -->
            ...
            <div class="col-md-12">
                <div class="tabbable tabbable-tabdrop">
                    ...
                    <div class="portlet light portlet-fit portlet-form" id="form_wizard_1">
                        <!-- BEGIN FORM-->
                        <?php echo $__env->make('chambai.edit.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <!-- END FORM-->
                    </div>
