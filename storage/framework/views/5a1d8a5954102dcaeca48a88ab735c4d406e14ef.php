                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-icon right">
                                                            ...
                                                            <input type="text" class="form-control" name="congviec"  maxlength="191" value="<?php echo e($giangvien->congviec); ?>" /> </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-icon right">
                                                            ...
                                                            <input type="text" class="form-control" name="capbac" value="<?php echo e($giangvien->capbac); ?>" /> </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-icon right">
                                                            <i class="fa fa-book"></i>
                                                            <textarea id="w3review" name="khenthuong" rows="5" cols="30"> <?php echo e($giangvien->khenthuong); ?></textarea> </div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
