<form action="<?php echo e(route('nckh.add.post')); ?>" method="post" id="form_sample_2" class="form-horizontal">
    <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <div class="input-icon right">
                                    ...
                                    <input type="number" class="form-control" name="tiendo" required maxlength="191" value="<?php echo e(old('tiendo')); ?>" /> </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <div class="input-icon right">
                                    <i class="fa fa-home"></i>
                                    <input type="text" class="form-control" name="thoigian" id="thoigian" placeholder="dd-mm-yyyy" value="<?php echo e(old('thoigian')); ?>" /> </div>
                            </div>
                        </div>
