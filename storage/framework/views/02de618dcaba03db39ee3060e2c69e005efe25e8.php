<?php $__env->startSection('title', 'Chỉnh sửa Thông tin Dạy Giỏi'); ?>
...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                <li>
                    ...
                    <a href="<?php echo e(route('daygioi.index')); ?>">Sửa Thông Tin Dạy Giỏi</a>
                </li>
            </ul>
        </div>
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title">
            <i class="fa fa-edit"></i> Chỉnh sửa | <?php echo e($daygioi->ten); ?> 
        </h1>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
            ...
            <div class="col-md-12">
                <div class="tabbable tabbable-tabdrop">
                    ...
                    <div class="portlet light portlet-fit portlet-form" id="form_wizard_1">
                        <!-- BEGIN FORM-->
                        <?php echo $__env->make('daygioi.edit.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <!-- END FORM-->
                    </div>
