<?php $__env->startSection('title', 'Chỉnh sửa Công Việc Đột Xuất'); ?>
...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                <li>
                    ...
                    <a href="<?php echo e(route('dotxuat.index')); ?>">Sửa Thông Tin Công Việc Đột Xuất</a>
                </li>
            </ul>
        </div>
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title">
            <i class="fa fa-edit"></i> Chỉnh sửa | <?php echo e($dotxuat->ten); ?> 
        </h1>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
            ...
            <div class="col-md-12">
                <div class="tabbable tabbable-tabdrop">
                    ...
                    <div class="portlet light portlet-fit portlet-form" id="form_wizard_1">
                        <!-- BEGIN FORM-->
                        <?php echo $__env->make('dotxuat.edit.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <!-- END FORM-->
                    </div>
