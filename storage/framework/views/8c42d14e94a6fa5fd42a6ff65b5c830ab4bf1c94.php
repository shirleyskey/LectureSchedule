 <!-- /.modal -->
 <div class="modal fade bs-modal-lg" id="modal_read_bai" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div id="read-hdld">
                        ...
                        <div class="row">
                            <div class="col-md-3 text-center company-info-left">
                                <img class="company-logo" src="<?php echo e(asset('/uploads/logos')); ?>/<?php echo e(setting('company.logo', '')); ?>" alt="">
                            </div>
                            <div class="col-md-9 company-info-right">
                                <p class="company-name"><?php echo e(setting('company.name', '')); ?></p>
                                <p class="company-address"><strong><em>Địa chỉ:</em></strong> <?php echo e(setting('company.address', '')); ?></p>
                                <p class="company-phone"><strong><em>Điện thoại:</em></strong> <?php echo e(setting('company.phone', '')); ?> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <strong><em>Fax:</em></strong> <?php echo e(setting('company.fax', '')); ?></p>
                            </div>
                        </div>
                        <!-- END hđld header -->
                        ...
                        <div class="row content-hdld">
                            ...
                            <div class="row">
                                ...
                                <div class="d-contents col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <?php echo e(setting('company.address', '')); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="d-contents col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    Fax: <?php echo e(setting('company.fax', '')); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="d-contents col-lg-4 col-md-4 col-sm-4 col-xs-4 dai-dien-boi">
                                    Ông <?php echo e(setting('company.nguoi_dai_dien', '')); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="d-contents col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <?php echo e(setting('company.chuc_vu', '')); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="d-contents col-lg-4 col-md-4 col-sm-4 col-xs-4 nguoi-lao-dong">
                                    <?php echo e(($nhan_su->gioi_tinh == 1)?'Ông':'Bà'); ?> <?php echo e($nhan_su->ho_ten); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="d-contents col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <?php echo e(\Carbon\Carbon::parse($nhan_su->ngay_sinh)->format('d/m/Y')); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="d-contents col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <?php echo e($nhan_su->dia_chi_thuong_tru); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="d-contents col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                    <?php echo e($nhan_su->so_cmnd); ?>

                                </div>
                                <div class="d-contents col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    Ngày cấp: <?php echo e(\Carbon\Carbon::parse($nhan_su->ngay_cap_cmnd)->format('d/m/Y')); ?>

                                </div>
                                <div class="d-contents col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    Nơi cấp: <?php echo e($nhan_su->noi_cap_cmnd); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="d-contents col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                    <?php echo e($nhan_su->chuc_danh); ?>

                                    <?php if($nhan_su->bophan_id != 0): ?>
                                        <?php echo e($nhan_su->bophans->ten); ?>

                                    <?php elseif($nhan_su->phongban_id != 0): ?>
                                        <?php echo e($nhan_su->phongbans->ten); ?>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    Hợp đồng này được lập tại <?php echo e(setting('company.name', '')); ?> ngày: <strong class="ngay-ky-hdld"></strong>
                                </div>
                            </div>
                            <!-- END Điều khoản 5 -->
                            ...
                            <div class="row">
                                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 cot-trai text-center">
                                    ...
                                    <br><br><br><br>
                                    <p style="font-weight: bold; margin: 0 0 0 0;"><?php echo e($nhan_su->ho_ten); ?></p>
                                </div>
                                ...
                                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 cot-phai text-center">
                                    ...
                                    <p style="font-weight: bold; margin: 0 0 0 0;"><?php echo e(setting('company.chuc_vu', '')); ?></p>
                                    <br><br><br><br>
                                    <p style="font-weight: bold; margin: 0 0 0 0;"><?php echo e(setting('company.nguoi_dai_dien', '')); ?></p>
                                </div>
                            </div>
                            <!-- END Chữ ký -->
                        </div>
