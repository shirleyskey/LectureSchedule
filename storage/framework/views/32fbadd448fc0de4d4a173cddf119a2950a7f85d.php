<form action="<?php echo e(route('dang.edit.post', $dang->id)); ?>" method="post" id="form_sample_2" class="form-horizontal">
    <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <div class="input-icon right">
                                    ...
                                    <input type="text" class="form-control" name="ten" required maxlength="191" value="<?php echo e($dang->ten); ?>" /> </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <div class="input-icon right">
                                    ...
                                    <input type="date" class="form-control" name="thoigian" value="<?php echo e($dang->thoigian); ?>" /> </div>
                            </div>
                        </div>
