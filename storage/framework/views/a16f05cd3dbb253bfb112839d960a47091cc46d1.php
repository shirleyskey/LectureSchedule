                                ...
                                <?php if( $ds_giangvien->count() > 0 ): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php endif; // app('laratrust')->can ?>
                                            <?php if (app('laratrust')->can('delete-giangvien')) : ?>
                                            <a class="btn btn-xs red-mint" href="<?php echo e(route('giangvien.delete.get', $v->id)); ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa Giảng Viên này không?');" title="Xóa"> <i class="fa fa-trash"></i> Xóa</a>
                                            <?php endif; // app('laratrust')->can ?>
                                        </td>
                                    </tr>
                                    <?php $stt++; ?>
