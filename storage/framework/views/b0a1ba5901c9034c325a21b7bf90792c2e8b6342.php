<form action="<?php echo e(route('congtac.edit.post', $congtac->id)); ?>" method="post" id="form_sample_2" class="form-horizontal">
    <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <div class="input-icon right">
                                    ...
                                    <input type="text" class="form-control" name="ten" required maxlength="191" value="<?php echo e($congtac->ten); ?>" /> </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <div class="input-icon right">
                                    <i class="fa fa-home"></i>
                                    <input type="number" class="form-control" name="tiendo" value="<?php echo e($congtac->tiendo); ?>" /> </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <div class="input-icon right">
                                    ...
                                    <input type="date" class="form-control" name="thoigian" value="<?php echo e($congtac->thoigian); ?>" /> </div>
                            </div>
                        </div>
