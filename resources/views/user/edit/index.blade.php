                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-icon right">
                                                            ...
                                                            <input type="text" class="form-control" name="congviec" required maxlength="191" value="{{ $giangvien->congviec }}" /> </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-icon right">
                                                            ...
                                                            <input type="text" step="any" class="form-control" name="capbac" value="{{ $giangvien->capbac }}" /> </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-icon right">
                                                            <i class="fa fa-book"></i>
                                                            <textarea id="w3review" name="khenthuong" rows="4" cols="42"> {{ $giangvien->khenthuong }}</textarea> </div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
