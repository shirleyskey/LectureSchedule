...
@section('title', 'Thêm mới Dạy Giỏi')
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                <li>
                    ...
                    <a href="{{ route('daygioi.index') }}">Danh Sách Dạy Giỏi</a>
                </li>
            </ul>
        </div>
        <!-- END PAGE BAR -->
            ...
            <div class="col-md-12">
                <div class="tabbable tabbable-tabdrop">
                    ...
                    <div class="portlet light portlet-fit portlet-form" id="form_wizard_1">
                        <!-- BEGIN FORM-->
                        <form action="{{ route('daygioi.add.post') }}" method="post" id="form_sample_2" class="form-horizontal">
                            @csrf
