...
@section('title', 'Chỉnh sửa Sáng Kiến Cải Tiến')
...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                <li>
                    ...
                    <a href="{{ route('sangkien.index') }}">Sửa Thông Tin Công Việc Đột Xuất</a>
                </li>
            </ul>
        </div>
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title">
            <i class="fa fa-edit"></i> Chỉnh sửa | {{ $sangkien->ten }} 
        </h1>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
