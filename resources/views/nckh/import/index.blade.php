...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                <li>
                    ...
                    <a href="{{ route('nhan_su.index') }}">giảng viên trong khoa</a>
                </li>
            </ul>
        </div>
        <!-- END PAGE BAR -->
        ...
        <h1 class="page-title">
            ...
            Nhập liệu giảng viên bằng file Excel
        </h1>
                ...
                <form id="import_form" class="form-horizontal" action="{{ route('nhan_su.import-excel.post') }}" method="post">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <div class="col-md-12">
                                <input class="form-control" type="text" id="excel_link" name="excel_link" value="" disable>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
                                <button href="#" class="btn btn-default popup_selector"  data-inputid="excel_link">Chọn tập tin</button>
