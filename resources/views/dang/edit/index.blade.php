...
@section('title', 'Chỉnh sửa Thông tin Hoạt động Đảng/Đoàn')
...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                <li>
                    ...
                    <a href="{{ route('dang.index') }}">Sửa Thông Tin Công tác</a>
                </li>
            </ul>
        </div>
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title">
            <i class="fa fa-edit"></i> Chỉnh sửa | {{ $dang->ten }} 
        </h1>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
