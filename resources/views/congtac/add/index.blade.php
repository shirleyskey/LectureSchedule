                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-icon right">
                                                            ...
                                                            <input type="text" class="form-control" name="tiendo" required maxlength="191" value="{{ old('tiendo') }}" /> </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-icon right">
                                                            <i class="fa fa-home"></i>
                                                            <input type="datetime" class="form-control" name="thoigian" value="{{ old('thoigian') }}" /> </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
